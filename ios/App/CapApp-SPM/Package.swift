...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapgoCapacitorShareTarget", path: "../../../node_modules/.pnpm/@capgo+capacitor-share-target@8.0.22_@capacitor+core@8.2.0/node_modules/@capgo/capacitor-share-target")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
