  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-muted-foreground">Control how earnings are calculated for each flow.</p>
      </div>
                  ...
                  {!isProfitRemittance && !isEditing && (
                    <div className="mt-2.5 flex items-center gap-3">
                      <div className="rounded-lg bg-white/[0.06] px-2.5 py-1.5">
                        <p className="text-[10px] uppercase tracking-wider text-muted-foreground/70">Rate</p>
                        <p className="text-sm font-semibold tabular-nums">
                          {rule.profit_rate !== null ? `${rule.profit_rate}%` : "—"}
                        </p>
                      </div>
                      <div className="rounded-lg bg-white/[0.06] px-2.5 py-1.5">
                        <p className="text-[10px] uppercase tracking-wider text-muted-foreground/70">Min</p>
                        <p className="text-sm font-semibold tabular-nums">
      ...
      <p className="text-center text-[11px] leading-relaxed text-muted-foreground/50">
        Disabled rules will not apply profit. Platform-specific rules appear only while the platform is
        active.
      </p>
    </div>
  );
